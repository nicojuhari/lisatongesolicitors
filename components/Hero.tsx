        ...
        <section className="hero bg-gray-100 text-white py-28 md:py-42 relative overflow-hidden">
            ...
            <div className="container relative text-center">
                <h1 className="text-4xl md:text-5xl mb-4 font-bold">
                    Lisa Tonge Solicitors <span className="text-[30%] block font-normal mt-2 text-gray-200 italic">Your Legal Partner in Worsley, Manchester</span>
                </h1>
                <p className="md:max-w-[600px] mx-auto text-gray-200 mt-16 md:mt-20">
                I am a fully qualified solicitor experienced in Conveyancing, Wills and Probate, Mortgages and Leases, Business Documents ...
                </p>
