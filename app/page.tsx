    ...
    <>     
        ...
        <section className="py-14 md:py-18 bg-blue-900 text-white">
            <div className="container">
                <h2 className="section-title text-center">Free Initial Meeting</h2>
                <p className="mb-4">
                ...
                <p className="mb-4 texts-white">
                    <span className="font-semibold underline">EARLY EVENING AND WEEKEND</span> appointment are available by arrangement. <br /> 
                    <span> As a valued client you will have direct telephone and/or e-mail access to me from <span className="font-semibold underline">9 a.m. to 5 p.m. Monday to Friday</span>.</span>
                </p>
                <p className="mt-6 text-gray-300 italic text-sm">
